        ...
        <div class="content">
            <div class="d-flex align-items-center justify-content-center mb-5">
                ...
                <table class="table" id="userTable">
                        ...
                        <tbody>
                            <?php 
                                $result = mysqli_query($con,"select * from tbluser") or die("Error Occured while fetching user records.".mysqli_error($con));
                                $count = 1;
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="../uploads/user/<?php echo $img; ?>" target="_blank">
                                        <img src="../uploads/user/<?php echo $img; ?>" alt="image" width="120">
                                    </a>
                                </td>
                                <td>
                                    ...
                                    <?php } 
                                        ...
                                        <span class="text-muted fw-bold">Suspended</span>
                                    <?php } ?> 
                                    <a class="btn btn-primary" href="editUser.php?uid=<?php echo $userId; ?>">Edit</a>
                                    <a class="btn btn-danger mt-1" href="deleteUser.php?uid=<?php echo $userId; ?>&img=<?php echo $img; ?>">Delete</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
